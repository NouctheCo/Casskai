...
export const SYSCOHADA_PLAN: AccountPlan = {
  ...
  classes: [
    ...
    {
      number: '8',
      name: 'COMPTES DES AUTRES CHARGES ET DES AUTRES PRODUITS (HAO)',
      type: 'expense',
      accounts: [
        {
          number: '81',
        ...
        },
        {
          ...
          subAccounts: [
            ...
            { number: '838', name: 'Autres charges HAO', type: 'charges', isDebitNormal: true }
          ]
        },
        {
          number: '84',
          ...
          subAccounts: [
            ...
            { number: '848', name: 'Autres produits HAO', type: 'produits', isDebitNormal: false }
          ]
        },
        {
          number: '85',
        ...
        },
        {
          ...
          isDebitNormal: false,
          subAccounts: [
            { number: '881', name: 'Subventions d\'équilibre État', type: 'produits', isDebitNormal: false },
        ...
        },
        {
          ...
          subAccounts: [
            ...
            { number: '899', name: 'Autres impôts sur résultat', type: 'charges', isDebitNormal: true }
          ]
        }
      ]
    },
    {
      number: '9',
      name: 'COMPTES DE LA COMPTABILITÉ ANALYTIQUE',
      type: 'expense',
      accounts: [
        {
          number: '90',
          ...
          isDebitNormal: true,
          subAccounts: [
            { number: '901', name: 'Compte de liaison charges', type: 'charges', isDebitNormal: true },
            { number: '902', name: 'Compte de liaison produits', type: 'produits', isDebitNormal: false }
          ]
        },
        {
          number: '92',
          name: 'CENTRES D\'ANALYSE',
          type: 'charges',
          isDebitNormal: true,
          subAccounts: [
            { number: '921', name: 'Centres principaux', type: 'charges', isDebitNormal: true },
            { number: '922', name: 'Centres auxiliaires', type: 'charges', isDebitNormal: true }
          ]
        },
        {
          number: '93',
          ...
          isDebitNormal: true,
          subAccounts: [
            { number: '931', name: 'Coûts d\'achat', type: 'charges', isDebitNormal: true },
            { number: '932', name: 'Coûts de production', type: 'charges', isDebitNormal: true },
            { number: '934', name: 'Coûts de revient', type: 'charges', isDebitNormal: true }
          ]
        },
        {
          number: '94',
          ...
          isDebitNormal: true,
          subAccounts: [
            { number: '941', name: 'Stocks matières', type: 'stocks', isDebitNormal: true },
            { number: '943', name: 'Stocks produits finis', type: 'stocks', isDebitNormal: true }
          ]
        }
      ]
    }
