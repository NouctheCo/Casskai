...
export class CacheManager {
  ...
  static clearAll(): void {
    ...
    devLogger.info('🧹 Nettoyage complet du cache localStorage...');
    ...
    devLogger.info('✅ Cache localStorage nettoyé');
  ...
  static clearEnterprises(): void {
    ...
    devLogger.info('🏢 Nettoyage du cache des entreprises...');
    ...
    devLogger.info('✅ Cache des entreprises nettoyé');
  ...
  static clearAndReload(): void {
    ...
    devLogger.info('🔄 Rechargement de la page...');
  ...
  static triggerEnterpriseRefresh(): void {
    ...
    devLogger.info('🔄 Déclenchement d\'un rafraîchissement du contexte Enterprise...');
  ...
  static smartClean(): void {
    ...
    devLogger.info('🧠 Nettoyage intelligent du cache...');
    ...
    devLogger.info('📊 Rapport du cache:', report);

    devLogger.info('✅ Validation:', validation);



    if (!validation.isValid || report.hasEnterprises) {

      devLogger.info('🧹 Nettoyage nécessaire...');
      ...
      devLogger.info('✅ Cache propre, aucun nettoyage nécessaire');
