        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="md:hidden">
            ...
            <motion.button
              ...
              className="text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors dark:bg-gray-900/50"
            ...
            <div className="py-4 space-y-2">
              ...
              {navItems.map((item) => (
                ...
                <button
                  ...
                  className="block w-full text-left px-4 py-3 text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-gray-50 dark:hover:bg-gray-800 rounded-lg mx-2 transition-colors font-medium dark:bg-gray-900/30"
