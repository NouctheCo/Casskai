...
const ThemeDropdown: React.FC<{ className?: string }> = ({ className }) => {
  ...
  return (
    <div className={cn("relative", className)}>
      <motion.button
        className="flex items-center space-x-2 px-3 py-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 dark:border-gray-700 rounded-lg hover:shadow-md transition-shadow"
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            className="absolute top-full left-0 mt-2 w-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 dark:border-gray-700 rounded-lg shadow-lg z-50"
