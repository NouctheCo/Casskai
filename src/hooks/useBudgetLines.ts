...
export const useBudgetLines = ({ budgetId, onSuccess, onError }: UseBudgetLinesOptions) => {
  ...
  const fetchLines = useCallback(async () => {
    ...
    try {
      ...
      logger.error('UseBudgetLines', 'Error fetching budget lines:', err);
  ...
  const addLine = useCallback(
    async (category: Omit<BudgetCategory, 'id' | 'budget_id'>) => {
      ...
      try {
        ...
        logger.error('UseBudgetLines', 'Error adding budget line:', err);
  ...
  const updateLine = useCallback(
    async (lineId: string, updates: Partial<BudgetCategory>) => {
      ...
      try {
        ...
        logger.error('UseBudgetLines', 'Error updating budget line:', err);
  ...
  const deleteLine = useCallback(
    async (lineId: string) => {
      ...
      try {
        ...
        logger.error('UseBudgetLines', 'Error deleting budget line:', err);
