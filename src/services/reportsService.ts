...
class ReportsService {
  ...
  async getReports(companyId: string, filters?: ReportFilters): Promise<ReportServiceResponse<FinancialReport[]>> {
    try {      let query = supabase
      ...
      logger.error('Reports', 'Exception in getReports:', error instanceof Error ? error.message : String(error));
  ...
  async createReport(companyId: string, userId: string, formData: ReportFormData): Promise<ReportServiceResponse<FinancialReport>> {
    try {
      ...
      logger.error('Reports', 'Exception in createReport:', error instanceof Error ? error.message : String(error));
  ...
  async updateReport(reportId: string, formData: Partial<ReportFormData>): Promise<ReportServiceResponse<FinancialReport>> {
    try {
      ...
      logger.error('Reports', 'Exception in updateReport:', error instanceof Error ? error.message : String(error));
  ...
  async deleteReport(reportId: string): Promise<ReportServiceResponse<boolean>> {
    try {
      ...
      logger.error('Reports', 'Exception in deleteReport:', error instanceof Error ? error.message : String(error));
  ...
  async generateBalanceSheet(companyId: string, periodEnd: string): Promise<ReportServiceResponse<BalanceSheetData>> {
    try {
      ...
      if (error) {
        logger.error('Reports', 'Error generating balance sheet:', error);
        return { data: null, error: { message: error.message } };
      }
      return { data: data as BalanceSheetData };
    } catch (error) {
      logger.error('Reports', 'Exception in generateBalanceSheet:', error instanceof Error ? error.message : String(error));
  ...
  async generateIncomeStatement(companyId: string, periodStart: string, periodEnd: string): Promise<ReportServiceResponse<IncomeStatementData>> {
    try {
      ...
      if (error) {
        logger.error('Reports', 'Error generating income statement:', error);
        return { data: null, error: { message: error.message } };
      }
      return { data: data as IncomeStatementData };
    } catch (error) {
      logger.error('Reports', 'Exception in generateIncomeStatement:', error instanceof Error ? error.message : String(error));
  ...
  async generateCashFlowStatement(companyId: string, periodStart: string, periodEnd: string): Promise<ReportServiceResponse<CashFlowData>> {
    try {
      ...
      if (error) {
        logger.error('Reports', 'Error generating cash flow statement:', error);
        return { data: null, error: { message: error.message } };
      }
      return { data: data as CashFlowData };
    } catch (error) {
      logger.error('Reports', 'Exception in generateCashFlowStatement:', error instanceof Error ? error.message : String(error));
  ...
  async generateTrialBalance(companyId: string, periodEnd: string): Promise<ReportServiceResponse<TrialBalanceData>> {
    try {
      ...
      if (error) {
        logger.error('Reports', 'Error generating trial balance:', error);
        return { data: null, error: { message: error.message } };
      }
      return { data: data as TrialBalanceData };
    } catch (error) {
      logger.error('Reports', 'Exception in generateTrialBalance:', error instanceof Error ? error.message : String(error));
  ...
  async exportReport(reportId: string, config: ReportExportConfig): Promise<ReportServiceResponse<string>> {
    try {
      ...
      logger.warn('Reports', `Export du rapport ${report.name} en format ${config.format}`);
