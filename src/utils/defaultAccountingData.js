...
export const defaultJournals = [
  { code: 'VE', name: 'Journal des ventes', type: 'VENTE', description: 'Enregistrement des factures de vente', is_active: true },
  { code: 'AC', name: 'Journal des achats', type: 'ACHAT', description: 'Enregistrement des factures d\'achat', is_active: true },
  { code: 'BQ', name: 'Journal de banque', type: 'BANQUE', description: 'Mouvements bancaires', is_active: true },
  { code: 'CA', name: 'Journal de caisse', type: 'CAISSE', description: 'Mouvements de caisse', is_active: true },
  { code: 'OD', name: 'Opérations diverses', type: 'OD', description: 'Écritures diverses et de régularisation', is_active: true }
];