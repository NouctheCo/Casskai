...
export async function fixUnaccentExtension() {
  try {
    console.log('🔧 Activating unaccent extension on Supabase...');
    ...
    console.log('⚠️ NOTE: This fix requires service_role access');
...
SELECT unaccent('Créée');
    ...
    console.error('❌ Error fixing unaccent:', error);
    throw error;
  }
}
...
if (typeof window !== 'undefined') {
  ...
  console.log('✅ fixUnaccentExtension available as window.fixUnaccentExtension()');
}
