...
const plans = [
  ...
  },
  {
    ...
    features: [
      ...
      { text: '1 entreprise', included: true },
      { text: '1,000 transactions/mois', included: true },
      { text: 'Factures et devis illimités', included: true },
      { text: '1 GB stockage', included: true },
      { text: 'Support basique (48h)', included: true },
      { text: 'Sans filigrane', included: true },
      { text: 'Application mobile', included: true },
      { text: 'Backups cloud automatiques', included: true },
      { text: 'Multi-devises', included: false },
  ...
  },
  {
    ...
    features: [
      ...
      { text: '10,000 transactions/mois', included: true },
      { text: 'Tout Starter inclus', included: true },
      { text: '10 GB stockage', included: true },
      { text: 'Support prioritaire (24h)', included: true },
      { text: 'Multi-devises (XOF, EUR, USD)', included: true },
      { text: 'Rapports avancés', included: true },
      { text: 'Audit trail complet', included: true },
      { text: 'Champs personnalisés', included: true },
  ...
  },
  {
    ...
    currency: 'XOF',
    period: 'mois',
    description: 'Solution complète avec API et support premium',
    features: [
      ...
      { text: 'Tout Professionnel inclus', included: true },
      { text: '100 GB stockage', included: true },
      ...
      { text: 'Audit comptable trimestriel', included: true },
