...
export const PredictiveDashboard: React.FC<PredictiveDashboardProps> = ({
  ...
  const loadAIData = async () => {
    ...
    try {
      ...
      logger.error('PredictiveDashboard', 'Error loading AI data:', errorMessage);
    } finally {
      setIsLoading(false);
    }
  };
  const calculateMetrics = (_insights: AIInsight[] = [], predictions: CashFlowPrediction[] = [], alerts: SmartAlert[] = []) => {
