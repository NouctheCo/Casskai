                  ...
                  <AnimatePresence>
                    {expandedAnomalies.has(anomaly.transaction.id) && (
                      ...
                      >
                        ...
                        <div>
                          <h4 className="text-sm font-medium text-gray-700 dark:text-gray-300 dark:text-gray-300 mb-2">
                            Raisons détectées:
                          </h4>
                          <div className="space-y-1">
                            {anomaly.reasons.map((reason, reasonIndex) => (
                              <div 
                                key={reasonIndex}
                                className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400"
                              >
