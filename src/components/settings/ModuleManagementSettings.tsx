...
import { Settings, Star, CheckCircle, AlertCircle, Loader2, Save, Info } from 'lucide-react';
...
export function ModuleManagementSettings() {
  ...
  const handleModuleToggle = (moduleKey: string) => {
    ...
    setPendingChanges(prev => {
      ...
      if (Object.hasOwn(prev, moduleKey)) {
  ...
  const getEffectiveState = (moduleKey: string): boolean => {
    ...
    return Object.hasOwn(pendingChanges, moduleKey)
  ...
  const getModuleStatus = (moduleKey: string) => {
    ...
    const hasPendingChange = Object.hasOwn(pendingChanges, moduleKey);
