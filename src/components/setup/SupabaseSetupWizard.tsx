...
const SupabaseSetupWizard = () => {
  ...
  const validateSupabaseConnection = async () => {
    ...
    try {
      ...
      setError(error instanceof Error ? (error as Error).message : 'Erreur de validation');
  ...
  const saveConfiguration = async () => {
    ...
    try {
      ...
      setError(error instanceof Error ? (error as Error).message : 'Erreur lors de la sauvegarde');
