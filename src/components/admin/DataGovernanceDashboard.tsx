...
import {
  AlertTriangle, CheckCircle, Database, Search,
  Merge, Shield, BarChart3, RefreshCw,
  Eye, Award
} from 'lucide-react';
...
export const DataGovernanceDashboard: React.FC = () => {
  ...
  const loadDashboardData = async () => {
    ...
    try {
      ...
      logger.error('DataGovernanceDashboard', '❌ Erreur chargement dashboard:', error);
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      logger.error('DataGovernanceDashboard', '❌ Erreur recherche:', error);
