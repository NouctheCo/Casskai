...
export const ModularDashboard: React.FC<ModularDashboardProps> = ({
  ...
  const renderWidget = (widget: WidgetConfig, _layout: WidgetLayout) => {
    ...
    if (!widget || !widget.id || !widget.type) {
      logger.warn('ModularDashboard', 'Widget invalide:', widget);
      return null;
    }
  ...
  return (
    <div className={cn("relative", className)}>
      ...
      <div className="flex items-center justify-between mb-6 p-4 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-600 dark:border-gray-700">
      ...
      >
        <ResponsiveGridLayout
          ref={gridRef as unknown as React.LegacyRef<any>}
          className="layout"
          layouts={layouts}
