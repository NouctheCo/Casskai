    ...
    >
      <Card className={`h-full border-2 transition-all duration-300 ${
        ...
        <CardHeader className="text-center pb-4">
          ...
          <CardDescription className="text-gray-600 dark:text-gray-400 dark:text-gray-400 mt-2">
            {plan.description}
          </CardDescription>
          ...
          <div className="mt-4">
            <div className="flex items-baseline justify-center space-x-2">
              ...
              <span className="text-gray-500 dark:text-gray-400 dark:text-gray-400 text-lg">
        ...
        <CardContent className="pt-0">
          ...
          <div className="space-y-3 mb-6">
            {plan.features.map((feature, index) => (
              ...
              >
                ...
                <span className="text-sm text-gray-700 dark:text-gray-300 dark:text-gray-300 leading-relaxed">
                  {feature}
                </span>
              </motion.div>
            ))}
          ...
          <div className="mt-auto">
            ...
            {!isCurrentPlan && (
              <p className="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 text-center mt-2">
