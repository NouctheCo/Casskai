...
interface OpportunitiesKanbanProps {
  ...
  contacts?: Contact[];
  loading?: boolean;
  onCreateOpportunity?: ((data: OpportunityFormData) => Promise<void>) | (() => void);
...
const OpportunitiesKanban: React.FC<OpportunitiesKanbanProps> = ({
  ...
  const handleFormSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      logger.error('OpportunitiesKanban', 'Error submitting opportunity form:', error instanceof Error ? error.message : String(error));
    }
  };
