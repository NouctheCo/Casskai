...
import { ContractData, ContractFormData, ContractType, DiscountTier } from '../../types/contracts.types';
...
export const ContractForm: React.FC<ContractFormProps> = ({
  ...
  // Mock clients - en réalité, ces données viendraient du service thirdParties
  const [clients] = useState([
    { id: 'client_1', name: 'ACME Corporation' },
    { id: 'client_2', name: 'TechStart SAS' },
    { id: 'client_3', name: 'Global Industries' },
                      ...
                      <FormControl>
                        <div className="flex items-center space-x-2">
                          <Input
                            ...
                            className="w-32"
                          />
                          <span className="text-gray-500">% du chiffre d'affaires total</span>
                        </div>
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="text-gray-500 text-sm">indépendant du CA</span>
                        </div>
                      </FormControl>
                      <FormMessage />
                    </FormItem>
