          ...
          <div className="border-b pb-4">
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-300">{quote.clientName}</p>
              </div>
...
export default function OptimizedQuotesTab({ shouldCreateNew = false, onCreateNewCompleted }: OptimizedQuotesTabProps) {
  ...
  const loadQuotes = async () => {
    try {
      ...
      logger.warn('OptimizedQuotesTab', 'No quotes loaded (this is normal for empty database):', error instanceof Error ? error.message : String(error));
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center space-x-2">
              ...
              <div>
                <p className="text-sm font-medium text-gray-600 dark:text-gray-300">Total devis</p>
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center space-x-2">
              ...
              <div>
                <p className="text-sm font-medium text-gray-600 dark:text-gray-300">Acceptés</p>
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center space-x-2">
              ...
              <div>
                <p className="text-sm font-medium text-gray-600 dark:text-gray-300">Expirés</p>
