        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="space-y-4">
              ...
              <div>
                <Label className="text-sm font-medium text-gray-600 dark:text-gray-300">Numéro de facture</Label>
            ...
            <div className="space-y-4">
              ...
              <div>
                <Label className="text-sm font-medium text-gray-600 dark:text-gray-300">Méthode de paiement</Label>
...
export default function OptimizedPaymentsTab({ shouldCreateNew = false, onCreateNewCompleted }: OptimizedPaymentsTabProps) {
  ...
  const loadPayments = async () => {
    try {
      ...
      const transformedPayments = paymentsData.map(payment => ({
        ...
        clientId: payment.third_party_id || '',
        clientName: payment.third_party?.name || 'Client inconnu',
      ...
      logger.error('OptimizedPaymentsTab', 'Error loading payments:', error instanceof Error ? error.message : String(error));
  ...
  const handleExportPayments = () => {
    ...
    try {
      ...
      logger.error('OptimizedPaymentsTab', 'Error exporting payments:', error);
      toast({
        title: "Erreur",
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center space-x-2">
              ...
              <div>
                <p className="text-sm font-medium text-gray-600 dark:text-gray-300">Total paiements</p>
