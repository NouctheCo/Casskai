    ...
    return (
      <div className="flex items-center justify-center h-64">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-300">Chargement du feedback...</p>
        </div>
      </div>
    );
  }
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300">Éloges</p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300">Constructifs</p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300">Reconnaissances</p>
            </div>
          </CardContent>
        </Card>
      </div>
        ...
        {filteredFeedbacks.length === 0 ? (
          ...
          filteredFeedbacks.map((feedback) => (
            <Card key={feedback.id} className="hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <div className="bg-gray-50 p-4 rounded-lg mb-4 dark:bg-gray-900/30">
                  <p className="text-gray-700 dark:text-gray-300 whitespace-pre-wrap">{feedback.content}</p>
                </div>

                {feedback.response && (
                  <div className="border-l-4 border-blue-500 pl-4 py-2">
                    <p className="text-sm font-semibold text-blue-700 mb-1 dark:text-blue-400">Réponse:</p>
