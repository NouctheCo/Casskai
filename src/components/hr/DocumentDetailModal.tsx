      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-5xl max-h-[90vh] overflow-hidden flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto p-6">
          ...
          <div className="grid grid-cols-2 gap-4 mb-6 p-4 bg-gray-50 rounded-lg">
            <div>
              <p className="text-sm font-medium text-gray-600">Généré le</p>
              <p className="text-sm">
            ...
            {document.sent_date && (
              <div>
                <p className="text-sm font-medium text-gray-600">Envoyé le</p>
                <p className="text-sm">
            ...
            {document.signed_date && (
              <div>
                <p className="text-sm font-medium text-gray-600">Signé le</p>
                <p className="text-sm">
            ...
            {document.is_archived && (
              <div>
                <p className="text-sm font-medium text-gray-600">Archive</p>
