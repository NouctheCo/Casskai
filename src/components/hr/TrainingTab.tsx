    ...
    return (
      <div className="flex items-center justify-center h-64">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-300">Chargement des formations...</p>
        </div>
      </div>
    );
  }
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300">Inscriptions</p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300">Taux de complétion</p>
            </div>
          </CardContent>
        </Card>
                  ...
                  <CardContent>
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-4">
                      <div className="bg-blue-50 p-3 rounded-lg dark:bg-blue-900/20">
                        <p className="text-xs text-gray-600 dark:text-gray-300 mb-1">Inscrits</p>
                      ...
                      <div className="bg-green-50 p-3 rounded-lg dark:bg-green-900/20">
                        <p className="text-xs text-gray-600 dark:text-gray-300 mb-1">Présents</p>
                    ...
                    {session.max_participants && session.registered_count !== undefined && (
                      <div className="mb-4">
                        <div className="flex justify-between text-sm mb-1">
                          <span className="text-gray-600 dark:text-gray-300">Capacité</span>
                  ...
                  <Card key={cert.id} className="hover:shadow-lg transition-shadow">
                    ...
                    <CardContent>
                      ...
                      <div className="grid grid-cols-2 gap-2 text-sm">
                        <div>
                          <span className="text-gray-600 dark:text-gray-300">Obtenue: </span>
                          <span className="font-semibold">
