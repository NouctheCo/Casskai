...
export function DocumentGenerationTab({ companyId, employees }: DocumentGenerationTabProps) {
  ...
  const getStatusIcon = (status: GeneratedDocumentStatus) => {
    switch (status) {
      case 'draft': return <Clock className="w-4 h-4 text-gray-600 dark:text-gray-300 dark:text-gray-300" />;
      ...
      case 'archived': return <Archive className="w-4 h-4 text-gray-600 dark:text-gray-300 dark:text-gray-300" />;
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-6">
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600 dark:text-gray-300 dark:text-gray-300">Brouillons</p>
                <p className="text-2xl font-bold text-gray-600 dark:text-gray-300 dark:text-gray-300">{stats.draft}</p>
              </div>
              <Clock className="w-8 h-8 text-gray-600 dark:text-gray-300 dark:text-gray-300" />
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600 dark:text-gray-300 dark:text-gray-300">Générés</p>
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600 dark:text-gray-300 dark:text-gray-300">Envoyés</p>
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600 dark:text-gray-300 dark:text-gray-300">Signés</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {templates.map((template) => (
              <Button
                ...
                className="h-auto p-4 flex flex-col items-start gap-2 hover:border-blue-500 hover:bg-blue-50 dark:bg-blue-900/20"
              >
        ...
        <CardContent>
          ...
          {filteredDocuments.length === 0 && (
            <div className="text-center py-12">
              ...
              <p className="text-gray-600 dark:text-gray-300 dark:text-gray-300">Générez votre premier document à partir d'un template</p>
            </div>
          )}
        </CardContent>
      </Card>
