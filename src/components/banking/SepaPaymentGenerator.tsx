      ...
      <Card>
        <CardContent className="p-8 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400 dark:text-gray-400">Chargement des paiements...</p>
          </div>
        </CardContent>
      </Card>
    );
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="bank-account" className="text-gray-700 dark:text-gray-300 dark:text-gray-300">Compte bancaire émetteur *</Label>
              <Select value={selectedBankAccount} onValueChange={setSelectedBankAccount}>
                <SelectTrigger id="bank-account" className="bg-white dark:bg-gray-800 dark:bg-gray-800 border-gray-300 dark:border-gray-600 dark:border-gray-600 text-gray-900 dark:text-gray-100 dark:text-gray-100">
                  <SelectValue placeholder="Sélectionner un compte" />
                </SelectTrigger>
                <SelectContent className="bg-white dark:bg-gray-800 dark:bg-gray-800 border-gray-300 dark:border-gray-600 dark:border-gray-600">
            ...
            {/* Date d'exécution */}
            <div className="space-y-2">
              <Label htmlFor="execution-date" className="text-gray-700 dark:text-gray-300 dark:text-gray-300">Date d'exécution souhaitée *</Label>
              <Input
                id="execution-date"
                type="date"
                value={executionDate}
                ...
                className="bg-white dark:bg-gray-800 dark:bg-gray-800 border-gray-300 dark:border-gray-600 dark:border-gray-600 text-gray-900 dark:text-gray-100 dark:text-gray-100"
              />
            </div>
          </div>
        </CardContent>
        ...
        <CardContent>
          {allPayments.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-lg font-medium text-gray-600 dark:text-gray-400 dark:text-gray-400 mb-2">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center justify-between mb-2">
                          <div>
                            ...
                            <p className="text-sm text-gray-600 dark:text-gray-400 dark:text-gray-400">{payment.description}</p>
                          </div>
                        ...
                        <div className="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400 space-y-1">
