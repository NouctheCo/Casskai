...
const SecuritySettingsPage: React.FC = () => {
  ...
  const loadSecurityData = useCallback(async () => {
    try {
      ...
      logger.error('SecuritySettings', 'Failed to load security data:', error instanceof Error ? error.message : String(error));
      toast({
        variant: "destructive",
        title: "Error",
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => {
                      const policy = { ...(securitySettings?.passwordPolicy ?? {}), minLength: parseInt(e.target.value) } as any;
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => {
                      const policy = { ...(securitySettings?.passwordPolicy ?? {}), maxAge: parseInt(e.target.value) } as any;
                      handleSecuritySettingsUpdate({ passwordPolicy: policy });
                    }}
                    className="w-20"
                  />
                ...
                {[
                  ...
                  <div key={key} className="flex items-center justify-between">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) => {
                        const policy = { ...(securitySettings?.passwordPolicy ?? {}), [key]: checked } as any;
                        handleSecuritySettingsUpdate({ passwordPolicy: policy });
                      }}
                    />
                  </div>
