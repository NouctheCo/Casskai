...
const ForecastReportView: React.FC<ForecastReportViewProps> = ({
  ...
  const handleExportPDF = async () => {
    try {
      const _reportConfig: Partial<ForecastReport> = {
      ...
      logger.error('ForecastReportView', 'Erreur lors de la génération du PDF:', error instanceof Error ? error.message : String(error));
    }
  };
