  ...
  useEffect(() => {
    ...
    if (stored) {
      try {
        ...
        logger.error('IntelligentSidebar', 'Error loading sidebar preferences:', error instanceof Error ? error.message : String(error));
      }
    }
  }, [user, activeModules]);
      ...
      <div className="p-4 border-b border-gray-200 dark:border-gray-600 dark:border-gray-700">
        ...
        {collapsed && (
          <div className="flex justify-center">
            <Command className="h-6 w-6 text-gray-600 dark:text-gray-300" />
          </div>
        )}
      </div>
            ...
            <div className="mb-4">
              ...
              <div className="space-y-1">
                {getFavoriteModulesData().map((module) => {
                  ...
                  const IconComponent = MODULE_ICONS[module.key as keyof typeof MODULE_ICONS] || FileText;
