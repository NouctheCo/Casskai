...
export const EInvoicingDashboard: React.FC<EInvoicingDashboardProps> = ({ 
  ...
  const handleEnableFeature = async () => {
    try {
      ...
      logger.error('EInvoicingDashboard', 'Error enabling e-invoicing:', error instanceof Error ? error.message : String(error));
    }
  };
  const handleDisableFeature = async () => {
    try {
      ...
      logger.error('EInvoicingDashboard', 'Error disabling e-invoicing:', error instanceof Error ? error.message : String(error));
    }
  };
