...
export const BudgetCard: React.FC<BudgetCardProps> = ({
  ...
  return (
    ...
    <Card className="hover:shadow-md transition-shadow bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-600 dark:border-gray-700">
      ...
      <CardContent className="p-6">
        ...
        <div className="flex items-center justify-between text-sm text-gray-500 dark:text-gray-400 pt-4 border-t border-gray-200 dark:border-gray-600 dark:border-gray-700">
