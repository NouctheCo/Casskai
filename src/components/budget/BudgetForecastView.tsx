  ...
  const loadForecast = async () => {
    try {
      ...
      if (error) {
        ...
        logger.error('BudgetForecastView', 'Forecast error:', error);
      } else {
        setForecastData(data);
      }
    } catch (error) {
      logger.error('BudgetForecastView', '...', error);
      toast({
        title: 'Erreur',
        ...
        <div className="flex items-center space-x-3">
          <div className="flex items-center space-x-2">
            ...
            <input
              ...
              className="px-3 py-2 border border-gray-300 dark:border-gray-600 dark:border-gray-600 rounded-md text-sm bg-white dark:bg-gray-800 dark:text-gray-100"
            />
          </div>
      ...
      {viewMode === 'totals' && (
        <div className="space-y-4">
          {[
            ...
            return (
              <Card key={key} className="bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-600 dark:border-gray-700">
                <CardHeader>
