...
import { Save, X, Plus, Trash2, Calculator, TrendingUp, CheckCircle, DollarSign, BarChart3 } from 'lucide-react';
...
export const BudgetFormModern: React.FC<BudgetFormModernProps> = ({
  ...
  const _monthNames = ['Jan', 'Fév', 'Mar', 'Avr', 'Mai', 'Jun', 'Jul', 'Aoû', 'Sep', 'Oct', 'Nov', 'Déc'];
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <Calculator className="absolute right-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-gray-400 dark:text-gray-500" />
