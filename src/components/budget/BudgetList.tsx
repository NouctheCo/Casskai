  ...
  if (budgets.length === 0) {
    ...
    return (
      ...
      <div className="text-center py-12">
        ...
        <AlertCircle className="w-16 h-16 text-gray-400 dark:text-gray-600 dark:text-gray-400 dark:text-gray-500 mx-auto mb-4" />
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      {budgets.map((budget) => (
        ...
        <BudgetCard
          ...
          onExport={onExport ? () => onExport(budget) : undefined}
