            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center gap-2 mt-1">
                ...
                {isActive ? (
                  ...
                  <Badge variant="outline" className="border-gray-300 dark:border-gray-600 dark:border-gray-600 text-gray-600 dark:text-gray-300">
            ...
            <CardContent className="p-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-gray-600 dark:text-gray-300">Accessibles</p>
            ...
            <CardContent className="p-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-gray-600 dark:text-gray-300">Core</p>
