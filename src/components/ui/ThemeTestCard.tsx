      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Card className="border border-gray-200 dark:border-gray-600 dark:border-gray-700">
          <CardHeader className="border-b border-gray-200 dark:border-gray-600 dark:border-gray-700">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 dark:text-gray-300 dark:text-gray-300">Vérification UI/UX</p>
              </div>
            </div>
          </CardHeader>
          ...
          <CardContent className="p-4 space-y-3">
            ...
            >
              <Users className="mr-3 h-4 w-4 text-gray-500 dark:text-gray-300 dark:text-gray-300" />
              <div className="flex-1 text-left">
                <div className="font-medium">Navigation Item</div>
                <div className="text-xs text-gray-500 dark:text-gray-300 dark:text-gray-300">Description test</div>
              </div>
