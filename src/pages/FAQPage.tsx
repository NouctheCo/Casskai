      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mt-12 grid md:grid-cols-4 gap-6">
          ...
          >
            ...
            <p className="text-sm text-gray-600 dark:text-gray-300">CGU, CGV, Confidentialité</p>
          </a>
          ...
          >
            ...
            <p className="text-sm text-gray-600 dark:text-gray-300">Prochaines fonctionnalités</p>
          </a>
          ...
          >
            ...
            <p className="text-sm text-gray-600 dark:text-gray-300">Exporter, supprimer</p>
          </a>
          ...
          >
            ...
            <p className="text-sm text-gray-600 dark:text-gray-300">Voir tous les plans</p>
          </a>
        </div>
      </div>
    </div>
