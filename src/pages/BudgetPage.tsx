...
const BudgetPage: React.FC = () => {
  ...
  const handleBudgetSaved = (budget: any) => {
    logger.debug('Budget', 'Budget saved:', budget);
    setViewMode('list');
    setEditingBudgetId(undefined);
  };
  const handleCancel = () => {
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <div className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        ...
        {(viewMode === 'create' || viewMode === 'edit') && (
          <Card className="shadow-lg border-0 bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-600 dark:border-gray-700">
            <BudgetForm
              companyId={currentEnterprise.id}
