      ...
      <div className="pt-24 pb-16">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-gray-600 dark:text-gray-400 dark:text-gray-400 mt-4 text-lg">
                  ...
                  >
                    ...
                    <Card>
                      ...
                      <CardContent className="p-6">
                        ...
                        <div className="flex items-center mt-4 text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400">
