          ...
          <div className="p-8 space-y-8">
            ...
            <section>
              ...
              <div className="bg-slate-50 dark:bg-gray-900/50 rounded-xl p-6 space-y-3">
                <div>
                  <p className="font-semibold text-gray-900 dark:text-white">Raison sociale</p>
                  <p className="text-gray-700 dark:text-gray-300">NOUTCHE CONSEIL</p>
                </div>
                <div>
                  <p className="font-semibold text-gray-900 dark:text-white">Forme juridique</p>
                  <p className="text-gray-700 dark:text-gray-300">Société par Actions Simplifiée Unipersonnelle (SASU)</p>
                </div>
                <div>
                  <p className="font-semibold text-gray-900 dark:text-white">Capital social</p>
                  <p className="text-gray-700 dark:text-gray-300">1 500 €</p>
                </div>
                <div>
                  <p className="font-semibold text-gray-900 dark:text-white">SIREN</p>
                  <p className="text-gray-700 dark:text-gray-300">909 672 685</p>
                </div>
                <div>
                  <p className="font-semibold text-gray-900 dark:text-white">SIRET</p>
                  <p className="text-gray-700 dark:text-gray-300">909 672 685 00023</p>
                </div>
                <div>
                  <p className="font-semibold text-gray-900 dark:text-white">RCS</p>
                  <p className="text-gray-700 dark:text-gray-300">Evry B 909 672 685</p>
                </div>
                <div>
                  <p className="font-semibold text-gray-900 dark:text-white">N° TVA Intracommunautaire</p>
                  <p className="text-gray-700 dark:text-gray-300">FR85909672685</p>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="bg-slate-50 dark:bg-gray-900/50 rounded-xl p-6 space-y-3">
                <div>
                  <p className="font-semibold text-gray-900 dark:text-white">Hébergeur</p>
                  <p className="text-gray-700 dark:text-gray-300">Hostinger International Ltd</p>
                </div>
                <div>
                ...
                <div>
                  <p className="font-semibold text-gray-900 dark:text-white">Site web</p>
                  <a
